...
import com.example.myapplication.databinding.FragmentNavHostMineBinding
 ...
 *@描述
 */
class MineNavHostFragment : BaseDBFragment<FragmentNavHostMineBinding>(),
    NavController.OnDestinationChangedListener {
    private val mViewModel: MainActivityViewModel by activityViewModels()
    private var navController: NavController? = null
    private val nestedNavHostFragmentId = R.id.nested_nav_host_fragment_mine
    override fun layoutId(): Int = R.layout.fragment_nav_host_mine
