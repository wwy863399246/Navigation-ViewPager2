...
import com.example.myapplication.databinding.FragmentNavHostCourseBinding
 ...
 *@描述
 */
class CourseNavHostFragment : BaseDBFragment<FragmentNavHostCourseBinding>(),
    NavController.OnDestinationChangedListener {
    private val mViewModel: MainActivityViewModel by activityViewModels()
    private var navController: NavController? = null
    private val nestedNavHostFragmentId = R.id.nested_nav_host_fragment_course
    override fun layoutId(): Int = R.layout.fragment_nav_host_course
